/*
    Effect for debugging shaders, ie stuff without any fancy shading, and just
    vertex colors.
*/
...
technique10 render_pos_color
{
    pass P0
    {
        ...
        SetVertexShader( CompileShader( vs_4_0, VS_POS_COLOR() ) );
        SetGeometryShader( NULL );
        SetPixelShader( CompileShader( ps_4_0, PS_POS_COLOR() ) );
    }
}
