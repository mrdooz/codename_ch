...
float4 ShadingSAT_PS(Shading_PSIn Input) : SV_Target
{
    ...
    //float3 Color = PerPixelLighting(Input.PosWorld, Normal, Input.TexCoord, DirToLight, LightContrib);
	//LightContrib = float3(1,1,1);
    float3 Color = PerPixelLighting(Input.PosWorld, Normal, DirToLight, LightContrib);
