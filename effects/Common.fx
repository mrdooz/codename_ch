...
float    g_MinFilterWidth = 16;                    // Minimum filter width
bool     g_LBR = true;                               // Enable/disable light bleeding reduction
float    g_LBRAmount = 0.18f;                         // Aggressiveness of light bleeding reduction
                        ...
                        float3 LightContrib)
{
    ...
    float3 DiffuseColor = float3(1,1,1); //texDiffuse.Sample(sampAnisotropicWrap, TexCoord);
