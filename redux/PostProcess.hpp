...
private:
  ...
  void SetSourceTexture(ID3D10ShaderResourceView* Texture)
  {
    ...
    ENFORCE_HR(m_EffectSourceTexture->SetResource(Texture));
    ENFORCE_HR(m_EffectSourceTextureArray->SetResource(Texture));
    ENFORCE_HR(m_EffectSourceTextureUint->SetResource(Texture));
  }
