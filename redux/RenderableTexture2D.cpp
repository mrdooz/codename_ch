  ...
  , m_Texture(0), m_RenderTarget(0), m_ShaderResource(0)
{
  ...
  ENFORCE_HR(d3dDevice->CreateTexture2D(&TexDesc, NULL, &m_Texture));
  ...
  ENFORCE_HR(d3dDevice->CreateRenderTargetView(m_Texture, &RTDesc, &m_RenderTarget));
  ...
  ENFORCE_HR(d3dDevice->CreateShaderResourceView(m_Texture, &SRDesc, &m_ShaderResource));
}
